...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/style-pref.css">
    ...
    <header>
        ...
        <div id="navbar">
            <ul>
                ...
                <a href="./préférence.php">Mes Préférences</a>
                <a href="./index.php">Découvrez aussi</a>
            </ul>
        </div>
    </header>
    <div class="preferences">
        <h2>quelles sont vos préférences ?</h2>
        <div id="wrap-img">
