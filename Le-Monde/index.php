...
<body>
    ...
    <main>
        <h2 class="title-section">Thématique</h2>
        <div class="wrap"> 
            <div class="thematique">
                <img src="./assets/img/articles-commerce-Marketing.jpg" alt="" class="img-size">
                <h2>titre</h2>
                <p>description</p>
            </div>
            <div class="thematique">
        ...
        <div class="btn"><button>Voir plus</button></div>
        <h2 class="title-section">Thématique</h2>
        <div class="wrap"> 
            <div class="thematique">
                <img src="./assets/img/articles-commerce-Marketing.jpg" alt="" class="img-size">
        ...
        <div class="btn"><button>Voir plus</button></div>
        <h2 class="title-section">Découvrez aussi</h2>
        <div class="wrap"> 
            <div class="discover">
                <img src="./assets/img/articles-commerce-Marketing.jpg" alt="" class="img-size">
                <h2>titre</h2>
